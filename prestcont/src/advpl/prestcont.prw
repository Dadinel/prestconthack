...
Class prestcont From CloudBridgeApp
	Data StartTime
...
Method New() Class prestcont
	SELF:StartTime:= Seconds()
Return

Method OnStart() Class prestcont
	SELF:WebView:navigate(SELF:RootPath + "index.html")
Return

Method OnLoadFinished(url) Class prestcont
	Local script
	Local loadTime
